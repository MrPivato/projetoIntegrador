        ...
        if(isset($_GET["op"])){
                ...
                if (isset($_GET["codBarras"])) {
                        ...
                        if($_GET["op"] == "exc"){
                                ...
                                $retorno=$livroControle->controleAcao("excluir");
                                if($retorno) {$msg="Livro excluído com sucesso!";}
                                else{$erro="Houve um erro na exclusão do Livro!";}
                        }
                }
        }
}
